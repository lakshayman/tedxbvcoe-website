...
import themeVideoClip from '../../../assets/2021/hero/theme-video-clip.mp4';
import videoPosterDesktop from '../../../assets/2021/hero/hero-section-video-poster.jpg';

import './Hero.styles.scss';

const Hero = () => {
  return (
    <section id='home' className='section section-hero2021'>
      <Fade>
