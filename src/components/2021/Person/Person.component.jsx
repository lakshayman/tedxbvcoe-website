...
import DisplayImagePlaceholder from '../../../assets/2021/team/placeholder.png';
import placeholderImage from '../../../assets/2021/team/blur-placeholder.jpg';
...
const Person = ({ member, isCore }) => {
  ...
  return (
    <div className={`member2021 ${isCore ? 'core' : 'organising'}`}>
